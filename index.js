...
const connection = new Connection(
  DEVNET_MODE ? clusterApiUrl("devnet") : process.env.MAINNET_RPC_URL,
  "confirmed"
);
...
const sendAndConfirmTransactions = async (connection, payer, transactions) => {
  ...
  for (const tx of transactions) {
    ...
    } else signature = await connection.sendTransaction(tx, [payer]);
...
const buyToken = async (mintAddress, tokenAmount) => {
  ...
  const slippage = new Percent(1, 100); //This is Slippage . You can change this. ex: new Percent(1, 100)->1%,  new Percent(50, 100)->50%
...
const createToken = async (name, symbol, decimals, totalSupply) => {
  ...
  await createOpenBookMarket(mint.toBase58(), 1, 0.01);
...
// createToken("MyTestToken", "MTT", 6, 1000000000);//create token,disable FreezeAuthority, mint token to payer, createOpenBookMarketID
createPool("C61xP5EVo4xjGa22s6qdArkH36mp6buEKTGbVacNQa8b", 800000000, 1);
// buyToken("C61xP5EVo4xjGa22s6qdArkH36mp6buEKTGbVacNQa8b", 1000);
// sellToken("C61xP5EVo4xjGa22s6qdArkH36mp6buEKTGbVacNQa8b", 1000);
...
//  createOpenBookMarket("BMSe5NDDYCdwPEhz82G4LwSwFpet7yk9DhfJnvTKcoX1", 1, 0.000001);
// disableFreezeAuthority("BMSe5NDDYCdwPEhz82G4LwSwFpet7yk9DhfJnvTKcoX1");